...
export function RecruitmentProcess1() {
  return (
      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            A comprehensive, data-driven approach to finding your next great hire. Our proven 6-step process combines industry expertise with modern recruitment methodologies.
          </p>
        </motion.div>
              ...
              >
                <div className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 items-center`}>
                  <div className="flex-1">
                    <Card className="relative h-full transition-all hover:shadow-lg hover:-translate-y-1">
                      {/* Step number badge */}
                      <div className="absolute -top-4 -left-4 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold shadow-lg">
                        {index + 1}
                      </div>
                          ...
                          <div className="space-y-4 w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="space-y-3">
                                <div>
                                  <h4 className="font-semibold mb-2 text-sm">Process Metrics</h4>
